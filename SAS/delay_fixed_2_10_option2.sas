...
%include "/udd/stlxu/ICER_mycode/DST/bhz&numbhz/hr&numhzr/calc10_option2.sas";
...
/*proc iml;
ETS=j(1000,20,0);
ccc={ah01,ah02,v,g,ICER,V_ICER,VV_ICER,VAR01,VAR02,VAR03,VAR04,VAR05,VAR06,VAR07,grad1,grad2,ah001,ah002,n0,n1};
...
%cycle(sim=all, Z1=Z1, Z2=Z2, group=group, O=O,n=1000, outdata=delay_2_10_option2, delay=1, avg=0.5) ;
