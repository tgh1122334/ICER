...
%include "/udd/stlxu/ICER_mycode/DST/bhz&numbhz/hr&numhzr/calc10_option4.sas";
...
%cycle(sim=all, Z1=Z1, Z2=Z2, group=group, O=O,n=1000, outdata=delay_2_10_option4, delay=1, avg=0.5) ;
